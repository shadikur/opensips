...
#Script Name: Complete OpenSIPs installation including GUI management & RTP Proxy
#OS Requirement: Debian 11.x - Bullseye x64
...
apt install wget git zip sudo unzip vim nano dialog curl net-tools lsb-release software-properties-common systemd systemd-sysv ca-certificates apt-transport-https -y
...
sudo apt update
sudo apt install -t bullseye-backports monit -y
...
#Install OpenSIPs
verbose "Adding OpenSIPs (3.2) stable LTS repository"
...
error "If you face any issue on deployment or in configuration, please feel free to contact to Mohammad or Jasdeep. Thank you.\n\n"
